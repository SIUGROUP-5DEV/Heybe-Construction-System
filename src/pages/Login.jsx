    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-8 max-w-lg">
          {/* Logo */}
          <div className="inline-flex items-center justify-center w-32 h-32 bg-white/20 backdrop-blur-sm rounded-full mb-8 border border-white/30">
            <Building2 className="w-20 h-32 text-white" />
          </div>
